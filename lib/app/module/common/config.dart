...
//const String DOMAIN = "liki.develop.gametector.com";
// const String DOMAIN = "fujimoto.develop.gametector.com";
const String API_BASE = 'https://' + DOMAIN + '/api';

const Locale locale = Locale('vi', 'VN');
//Twitter
const String TWITTER = 'twitter.com';
const String LANG_TWITTER = 'lang';
const String JA_TWITTER = 'ja';
...
const String API_APP_LOGIN = '/sign_in'; // ログイン（sign_in）
...
//Chat socket
//const String SOCKET_SERVER_URL = "wss://socket." + DOMAIN;
const String SOCKET_SERVER_URL = "wss://socket.develop.gametector.com";
const int NUMBER_RETRY_CONNECT_SOCKET = 1;
const int DELAY_CONNECT_SOCKET = 30 * 1000;
const String KEY_ACTION_SOCKET = "action";
const String KEY_DATA_SOCKET = "data";
enum SocketState {
  CLOSED, CLOSING, CONNECT_ERROR, RECONNECT_ATTEMPT, RECONNECTING, OPENING, OPEN, NEW_CONNECT,
}
//send chat
...
const int DELAY_POST_DATA_TYPING = 5 * 1000;
const int DELAY_HIDE_LAYOUT_TYPING = 3 * 1000;
